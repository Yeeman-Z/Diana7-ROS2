...
DIANA_API int initSrvV2(FNCERRORCALLBACK fnError, FNCWARNINGCALLBACK fnWarning,
                        FNCSTATECALLBACK fnState, srv_net_st* pinfo);

DIANA_API int destroySrv(const char* strIpAddress = "");

DIANA_API int setPushPeriod(int intPeriod,
                            /*IN*/ const char* strIpAddress = ""); // 设置状态推送频率
...
DIANA_API int addMoveJ(/*IN*/ unsigned int id_path, /*IN[7]*/ double* joints,
...
DIANA_API int servoJ(/*IN[7]*/ double* joints, /*IN*/ double time, /*IN*/ double look_ahead_time,
                     /*IN*/ double gain,
                     /*IN*/ const char* strIpAddress = "");

DIANA_API int servoL(/*IN[6]*/ double* pose, /*IN*/ double time, /*IN*/ double look_ahead_time,
                     /*IN*/ double gain,
                     /*IN*/ double scale, /*IN[6]*/ double* active_tcp = nullptr,
                     /*IN*/ const char* strIpAddress = "");

DIANA_API int servoJ_ex(/*IN[7]*/ double* joints, /*IN*/ double time, /*IN*/ double look_ahead_time,
                        /*IN*/ double gain,
                        /*IN*/ bool realiable, /*IN*/ const char* strIpAddress = "");

DIANA_API int servoL_ex(/*IN[6]*/ double* pose, /*IN*/ double time, /*IN*/ double look_ahead_time,
                        /*IN*/ double gain,
                        /*IN*/ double scale, /*IN*/ bool realiable,
                        /*IN[6]*/ double* active_tcp = nullptr,
                        /*IN*/ const char* strIpAddress = "");

DIANA_API int speedJ_ex(/*IN[7]*/ double* speed, /*IN*/ double a, /*option*/ double t,
                        /*IN*/ bool realiable,
                        /*IN*/ const char* strIpAddress = "");

DIANA_API int speedL_ex(/*IN[6]*/ double* speed, /*IN[2]*/ double* a, /*option*/ double t,
                        /*IN*/ bool realiable,
                        /*IN[6]*/ double* active_tcp = nullptr,
                        /*IN*/ const char* strIpAddress = "");
...
DIANA_API int readAI(/*IN*/ const char* groupName, /*IN*/ const char* IOName, /*OUT*/ int& mode,
                     /*OUT*/ double& value,
                     /*IN*/ const char* strIpAddress = "");
...
DIANA_API int writeAO(/*IN*/ const char* groupName, /*IN*/ const char* IOName, /*IN*/ int mode,
                      /*IN*/ double value,
                      /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getJacobiMatrix(/*OUT[7 * 6]*/ double* matrix_jacobi,
                              /*IN*/ const char* strIpAddress = "");
...
DIANA_API int setMappingAddress(double* dblAddress, int doubleItemCount, int8_t* int8Address,
                                int int8ItemCount,
                                /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getWayPoint(/*IN[64]*/ const char* waypointName, /*OUT[6]*/ double* dblTcppos,
                          /*OUT[7]*/ double* dblJoints, char* strToolName, char* strWorkpieceName,
                          /*IN*/ const char* strIpAddress = "");

DIANA_API int setWayPoint(/*IN[64]*/ const char* waypointName, /*IN[6]*/ double* dblTcppos,
                          /*IN[7]*/ double* dblJoints, const char* strToolName,
                          const char* strWorkpieceName, /*IN*/ const char* strIpAddress = "");

DIANA_API int addWayPoint(/*IN[64]*/ const char* waypointName, /*IN[6]*/ double* dblTcppos,
                          /*IN[7]*/ double* dblJoints, const char* strToolName,
                          const char* strWorkpieceName, /*IN*/ const char* strIpAddress = "");

DIANA_API int deleteWayPoint(/*IN[64]*/ const char* waypointName,
                             /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getInverseClosedJoints(/*IN*/ const int id, /*IN*/ const int index,
                                     /*OUT[7]*/ double* joints,
                                     /*IN*/ const char* strIpAddress = "");
...
DIANA_API int calculateJacobi(/*OUT[6*7]*/ double* dblJacobiMatrix,
...
DIANA_API int getTcpForceInToolCoordinate(/*OUT[6]*/ double* forces,
                                          /*IN*/ const char* strIpAddress = "");
...
DIANA_API int setControllerFeatureCode(/*IN*/ controller_feature intFeatureCode,
                                       /*IN*/ bool bEnable,
                                       /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getMechanicalJointsPositionRange(/*OUT[7]*/ double* dblMinPos,
                                               /*OUT[7]*/ double* dblMaxPos,
                                               /*IN*/ const char* strIpAddress = "");

DIANA_API int getMechanicalMaxJointsVel(/*OUT[7]*/ double* dblVel,
                                        /*IN*/ const char* strIpAddress = "");

DIANA_API int getMechanicalMaxJointsAcc(/*OUT[7]*/ double* dblAcc,
                                        /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getMaxCartTranslationVel(/*OUT*/ double& dblMaxCartTranslationVel,
                                       /*IN*/ const char* strIpAddress = "");

DIANA_API int getMaxCartRotationVel(/*OUT*/ double& dblMaxCartRotationVel,
                                    /*IN*/ const char* strIpAddress = "");

DIANA_API int getMaxCartTranslationAcc(/*OUT*/ double& dblMaxCartTranslationAcc,
                                       /*IN*/ const char* strIpAddress = "");

DIANA_API int getMaxCartRotationAcc(/*OUT*/ double& dblMaxCartRotationAcc,
                                    /*IN*/ const char* strIpAddress = "");
...
DIANA_API int setMaxCartTranslationVel(/*IN*/ double dblMaxCartTranslationVel,
                                       /*IN*/ const char* strIpAddress = "");

DIANA_API int setMaxCartRotationVel(/*IN*/ double dblMaxCartRotationVel,
                                    /*IN*/ const char* strIpAddress = "");

DIANA_API int setMaxCartTranslationAcc(/*IN*/ double dblMaxCartTranslationAcc,
                                       /*IN*/ const char* strIpAddress = "");

DIANA_API int setMaxCartRotationAcc(/*OUT*/ double dblMaxCartRotationAcc,
                                    /*IN*/ const char* strIpAddress = "");
...
DIANA_API int getDefaultActiveTcp(/*OUT[16]*/ double* default_tcp,
                                  /*IN*/ const char* strIpAddress = "");

DIANA_API int getFunctionOptI4(/*IN*/ int intFunctionIndex, /*IN*/ int intOptName,
                               /*OUT*/ int* intOptVal,
                               /*IN*/ const char* strIpAddress = "");

DIANA_API int setFunctionOptI4(/*IN*/ int intFunctionIndex, /*IN*/ int intOptName,
                               /*IN*/ int intOptVal,
                               /*IN*/ const char* strIpAddress = "");
...
DIANA_API int setSafetySpeedLimit(/*IN[7]*/ double* jointSafetySpeedLimit,
                                  /*IN[7]*/ double* tcpSafetySpeedLimit,
                                  /*IN*/ const char* strIpAddress = "");

DIANA_API int getSafetySpeedLimit(/*OUT[7]*/ double* jointSafetySpeedLimit,
                                  /*OUT[7]*/ double* tcpSafetySpeedLimit,
                                  /*IN*/ const char* strIpAddress = "");
